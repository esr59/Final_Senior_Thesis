...
void readPicoDstEshaMaker(const Char_t *inputFile="Run14_P18ih_HPSS_15164046.list", const Char_t *outputFile="test.root", Int_t nEv = 10, const Char_t *fOutJobappend="")
{
        Int_t nEvents = 10000;
//        Int_t nEvents = 1000;
//        Int_t nEvents = 100;
        ...
        if((RunYear == mRun14) && doTEST) inputFile = "Run14_P18ih_HPSS_15164046.list"; 
...
//        jetTask->SetRecombScheme(BIpt2_scheme); // recombination scheme
        jetTask->SetRecombScheme(E_scheme); // recomb - this scheme actually doesn't pre-process the 4-vectors during the recombination scheme to set mass to 0
        ...
        StEshaMaker *dummyMaker = new StEshaMaker("EshaMaker", picoMaker, outputFile, "JetMaker", "StRho_JetsBG");
...
void LoadLibs()
{
  ...
  gSystem->AddIncludePath("-I/star/u/esr59/Thesis/FastJet/fastjet-install/include");
