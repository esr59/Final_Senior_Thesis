#ifndef StEshaMaker_h
#define StEshaMaker_h
...
class StEshaMaker : public StJetFrameworkPicoBase {
  public:

    StEshaMaker(const char *name, StPicoDstMaker *picoMaker, const char *outName, const char *jetMakerName, const char *rhoMakerName);
    virtual ~StEshaMaker();
  ...
  private:
    ...
    // jet shape histo for different jet mass bins
    TH1F *hJetShape1;//!
    TH1F *hJetShape2;//!
    TH1F *hJetShape3;//!   
